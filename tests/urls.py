...
urlpatterns = patterns('',
    ...
    (r'^template/cached/(?P<foo>\w+)/$',
        cache_page(2.0)(TemplateView.as_view(template_name='about.html'))),
    ...
    (r'^detail/author/(?P<pk>\d+)/template_name/$',
        views.AuthorDetail.as_view(template_name='about.html')),
    ...
    (r'^detail/author/invalid/qs/$',
        views.AuthorDetail.as_view(query=None)),
    (r'^detail/nonmodel/1/$',
    ...
    (r'^list/authors/template_name/$',
        views.AuthorList.as_view(template_name='list.html')),
    ...
    (r'^list/authors/invalid/$',
        views.AuthorList.as_view(query=None)),
    ...
    (r'^dates/books/(?P<year>\d{4})/reverse/$',
        views.BookYearArchive.as_view(query=models.Book.objects.order_by('pubdate'))),
    ...
    (r'^dates/books/get_object_custom_query/(?P<year>\d{4})/(?P<month>[a-z]{3})/(?P<day>\d{1,2})/(?P<pk>\d+)/$',
